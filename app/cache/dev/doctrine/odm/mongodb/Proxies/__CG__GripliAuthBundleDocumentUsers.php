 ...
 */
class Users extends \Gripli\AuthBundle\Document\Users implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'lastname', 'firstname', 'email', 'facebookId', 'created', 'lastupdate', '' . "\0" . 'Gripli\\AuthBundle\\Document\\Users' . "\0" . 'cv', '' . "\0" . 'Gripli\\AuthBundle\\Document\\Users' . "\0" . 'type', 'username', 'usernameCanonical', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
