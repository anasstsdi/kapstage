 ...
 */
class Company extends \Gripli\AuthBundle\Document\Company implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'nameCompany', 'id', 'name', 'email', 'lastname', 'firstname', 'facebookId', 'created', 'lastupdate', 'username', 'usernameCanonical', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setNameCompany($nameCompany)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNameCompany', array($nameCompany));
    ...
    public function getNameCompany()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNameCompany', array());
