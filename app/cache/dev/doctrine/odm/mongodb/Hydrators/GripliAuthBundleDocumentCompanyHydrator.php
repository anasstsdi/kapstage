 ...
 */
class GripliAuthBundleDocumentCompanyHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        /** @Field(type="string") */
        if (isset($data['nameCompany'])) {
            $value = $data['nameCompany'];
            $return = (string) $value;
            $this->class->reflFields['nameCompany']->setValue($document, $return);
            $hydratedData['nameCompany'] = $return;
        }
        return $hydratedData;
    }
}